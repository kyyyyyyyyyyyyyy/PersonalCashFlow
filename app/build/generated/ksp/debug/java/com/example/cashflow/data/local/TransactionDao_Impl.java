  ...
  public TransactionDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTransactionEntity = new EntityInsertionAdapter<TransactionEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `transactions` (`id`,`type`,`amount`,`category`,`date`,`note`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
      ...
      public List<TransactionEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new TransactionEntity(_tmpId,_tmpType,_tmpAmount,_tmpCategory,_tmpDate,_tmpNote);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public TransactionEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final String _tmpNote;
            _tmpNote = _cursor.getString(_cursorIndexOfNote);
            _result = new TransactionEntity(_tmpId,_tmpType,_tmpAmount,_tmpCategory,_tmpDate,_tmpNote);
          } else {
            _result = null;
          }
          return _result;
